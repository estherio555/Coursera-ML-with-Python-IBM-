{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "# your code here\n",
    "#accur = 1- np.dot(y_testset- predTree)            #/np.sum(y_testset,y_testset))\n",
    "#accur"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    ...
    "!pip install -c conda-forge pydotplus  #!conda install -c conda-forge pydotplus  -y \n",
